        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-1.5 sm:gap-3 group">
            ...
            <div className="flex flex-col items-center pt-0.5">
              <div className="flex items-center font-serif text-[11px] sm:text-[13px] tracking-[0.15em] sm:tracking-[0.25em] leading-none font-semibold">
                <span className="text-neutral-900">Inkjector</span>
                <span className="text-[#C8A45D] ml-1 sm:ml-1.5">Tattoos</span>
              </div>
              <div className="flex items-center justify-center w-full gap-1.5 mt-1 sm:mt-1.5 pointer-events-none">
